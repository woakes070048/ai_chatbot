		...
		blocks.append(
			{
				...
				"content": (
					...
					f"`output_language` (default '{idp_output_language or 'English'}').\n"
					...
					"(Customer, Supplier, Items, UOMs) and shows editable fields for them.\n"
					...
					"2. Call `extract_document_raw` with the file_url. No preferences needed — "
